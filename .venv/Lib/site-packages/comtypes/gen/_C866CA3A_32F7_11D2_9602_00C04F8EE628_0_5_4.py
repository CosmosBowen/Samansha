...
__all__ = [
    'SpNullPhoneConverter', 'SPSEMANTICERRORINFO',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SRRTLength',
    'SVSFPurgeBeforeSpeak', 'SP_VISEME_17', 'SPPROPERTYINFO',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SVSpeakCompleteEvent', 'ISpRecoContext2',
    'DISPID_SRGReset', 'SPBO_TIME_UNITS', 'SpPhraseInfoBuilder',
    'SPAR_High', 'DISPID_SRGCmdLoadFromResource', 'SPSHT_EMAIL',
    'DISPID_SRRecognizer', 'SPFM_CREATE', 'SP_VISEME_8',
    'SDTReplacement', 'DISPID_SRGRecoContext',
    'DISPID_SRRGetXMLResult', 'ISpeechPhraseProperties',
    'SAFTADPCM_8kHzStereo', 'SAFT8kHz8BitMono', 'SAFT11kHz16BitMono',
    'DISPID_SRCEBookmark', 'SpeechRecoContextState',
    'SAFTCCITT_ALaw_8kHzMono', 'SPRECOSTATE',
    'ISpeechObjectTokenCategory', 'DISPID_SGRSTPropertyValue',
    'SPADAPTATIONRELEVANCE', 'SpAudioFormat', 'ISpObjectToken',
    'SpeechTokenShellFolder', 'DISPID_SPRText', 'DISPID_SPCIdToPhone',
    'SGDSActiveWithAutoPause', 'SpeechUserTraining',
    'DISPID_SFSClose', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SGRSTPropertyId', 'SPWAVEFORMATTYPE',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SAEventHandle',
    'SPTEXTSELECTIONINFO', 'SPFILEMODE', 'Speech_Max_Word_Length',
    'SPEI_MAX_TTS', 'ISpeechPhraseAlternate',
    'DISPID_SPERetainedSizeBytes', 'ISpRecoGrammar', 'SP_VISEME_2',
    'DISPID_SVSPhonemeId', 'SSFMOpenForRead',
    'ISpeechRecognizerStatus', 'SP_VISEME_16',
    'SPEI_FALSE_RECOGNITION', 'SP_VISEME_0',
    ...
    'DISPID_SLRemovePronunciationByPhoneIds', 'SAFT8kHz8BitStereo',
    'SVSFPersistXML', 'SPPS_RESERVED4', 'ISpXMLRecoResult',
    'DISPID_SDKGetlongValue', 'DISPID_SWFEExtraData',
    'SWPUnknownWordUnpronounceable', 'SVP_18', 'eLEXTYPE_RESERVED8',
    'SPCATEGORYTYPE', 'SpLexicon', 'SAFT16kHz8BitMono',
    'SAFTCCITT_ALaw_44kHzMono', 'SpeechGrammarState',
    'SAFTADPCM_8kHzMono', 'DISPID_SPPFirstElement',
    'DISPID_SVSLastStreamNumberQueued', 'SPEI_PHONEME',
    'DISPID_SLGetPronunciations', 'DISPID_SPPValue',
    'DISPID_SRGSetWordSequenceData', 'SGRSTTWildcard',
    'SVSFlagsAsync', 'DISPID_SVAudioOutputStream',
    'eLEXTYPE_RESERVED4', 'eWORDTYPE_ADDED', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SPRNumberOfElements', 'SpeechGrammarWordType',
    'SAFT12kHz16BitMono', 'DISPID_SPEs_NewEnum', 'SRAImport',
    'DISPID_SPPsItem', 'eLEXTYPE_PRIVATE20', 'SRTStandard',
    'DISPID_SLPType', 'SPDKL_DefaultLocation', 'DISPID_SRState',
    'DISPID_SPIAudioSizeTime', 'SPPS_RESERVED3', 'SVEAllEvents',
    'DISPID_SLWWord', 'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SRGId',
    'eLEXTYPE_PRIVATE1', 'SAFT24kHz16BitMono', 'UINT_PTR',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SRGetPropertyNumber',
    'ISpeechPhraseReplacement', 'DISPID_SVSInputWordLength',
    'DISPID_SPIStartTime', 'ISpAudio', 'SVEWordBoundary',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SpeechRecoResult2', 'SVP_20', 'SpeechLexiconType',
    'SpeechPartOfSpeech', 'DISPID_SOTMatchesAttributes',
    'DISPID_SABufferNotifySize', 'DISPID_SRRRecoContext',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SPSNotOverriden',
    'DISPID_SGRClear', 'DISPID_SRAudioInputStream',
    'DISPID_SDKEnumKeys', 'SRSEIsSpeaking', 'SVSFIsXML',
    'SECNormalConfidence', 'SSFMCreate', 'DISPID_SVEventInterests',
    'SPPS_RESERVED2', 'SPAR_Medium', 'SPSMF_SAPI_PROPERTIES',
    'SRTEmulated', 'DISPID_SOTIsUISupported', 'SRTAutopause',
    'SGSExclusive', 'SDTDisplayText', 'SVP_17', 'DISPID_SOTCId',
    'SpeechRecognitionType', 'SAFT48kHz16BitStereo',
    'DISPID_SGRAddResource', 'DISPID_SPPsCount', 'SpNotifyTranslator',
    'ISpRecognizer3', 'DISPID_SPRFirstElement', 'DISPID_SOTsCount',
    'SVEBookmark', 'ISpVoice', 'DISPID_SRGRules',
    'DISPID_SPPConfidence', 'SPVOICESTATUS', 'DISPID_SAVolume',
    'SPXMLRESULTOPTIONS', 'SPEI_START_SR_STREAM', 'DISPID_SPIRule',
    'SAFT8kHz16BitMono', 'SECFIgnoreKanaType', 'SpeechVoiceEvents',
    'ISpeechMMSysAudio', 'DISPID_SRGetFormat',
    'DISPID_SPRuleFirstElement', 'DISPID_SLWPronunciations',
    'SREPrivate', 'DISPIDSPTSI_ActiveOffset', 'SDTAll',
    'SpeechVoiceSkipTypeSentence', 'SpeechInterference',
    'eLEXTYPE_RESERVED7', 'eLEXTYPE_RESERVED10',
    'eLEXTYPE_USER_SHORTCUT', '_ISpeechRecoContextEvents',
    'DISPID_SLWType', 'DISPID_SpeechPhraseElements', 'SPCONTEXTSTATE',
    'SAFTCCITT_ALaw_8kHzStereo', 'ISpEventSink',
    'DISPID_SRCEAudioLevel', 'SPPHRASE', 'DISPID_SVESentenceBoundary',
    'DISPID_SPRuleName', 'DISPID_SPRuleId', 'SPBINARYGRAMMAR',
    'SPSLMA', 'SpeechVoiceCategoryTTSRate', 'DISPID_SOTCategory',
    'SECFDefault', 'STSF_CommonAppData', 'SPCT_SLEEP', 'SVSFDefault',
    'DISPID_SRCCreateGrammar', 'DISPID_SPEAudioTimeOffset',
    'SAFTText', 'SAFTGSM610_44kHzMono', 'DISPID_SOTCGetDataKey',
    'SRERecognition', 'SSFMOpenReadWrite', 'SpMMAudioIn',
    'ISpeechAudioStatus', 'DISPID_SRSCurrentStreamPosition',
    'SWTAdded', 'DISPID_SAFType', 'SAFTCCITT_uLaw_8kHzMono',
    'SVSFParseAutodetect', 'SpeechPropertyAdaptationOn',
    'SPEI_INTERFERENCE', 'SINone', 'SDTPronunciation',
    'DISPID_SPIEngineId', 'SPRECOCONTEXTSTATUS',
    'DISPID_SPRs_NewEnum', 'ISpObjectWithToken', 'SPAS_STOP',
    'eLEXTYPE_RESERVED6', 'SP_VISEME_14', 'DISPID_SBSWrite',
    'DISPID_SPAPhraseInfo', 'SASRun', 'DISPID_SVSpeak',
    'DISPID_SAStatus', 'STCInprocHandler', 'SP_VISEME_19',
    'SPEI_SR_AUDIO_LEVEL', 'SpeechDisplayAttributes', 'SPGS_DISABLED',
    'SVP_9', 'SVP_15', 'DISPID_SPIEnginePrivateData',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SRCEStartStream',
    'SpStreamFormatConverter', 'DISPID_SVSVisemeId',
    'DISPID_SpeechMemoryStream', 'ISpeechRecoContext',
    ...
    'SAFT11kHz8BitStereo', 'SPWF_SRENGINE',
    'DISPID_SRCVoicePurgeEvent', 'SPINTERFERENCE_TOOSLOW',
    'SPWORDPRONUNCIATIONLIST', 'SPLOADOPTIONS',
    'ISpeechLexiconPronunciation', 'SDKLDefaultLocation',
    'SpeechStreamFileMode', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SpeechAudio', 'DISPID_SVAlertBoundary',
    'ISpPhoneConverter', 'SPDKL_LocalMachine', 'SAFT12kHz8BitStereo',
    'SDTLexicalForm', 'SFTInput', 'SPPS_RESERVED1',
    'SAFTADPCM_44kHzMono', 'Speech_Max_Pron_Length',
    'DISPID_SRSClsidEngine', 'eLEXTYPE_LETTERTOSOUND',
    'ISpStreamFormatConverter', 'DISPID_SOTDataKey',
    'SAFT24kHz16BitStereo', 'SpeechCategoryRecoProfiles',
    'SpeechAudioFormatType', 'SINoise', 'SVP_1',
    'DISPID_SGRSAddRuleTransition', 'SPWORDPRONUNCIATION',
    'eLEXTYPE_APP', 'SPPS_SuppressWord', 'eLEXTYPE_PRIVATE8',
    'SPLO_DYNAMIC', 'DISPID_SpeechPhraseProperties',
    'DISPID_SRCEAdaptation', 'SP_VISEME_21', 'SPPS_Function',
    'ISpeechVoiceStatus', 'DISPID_SRRTOffsetFromStart',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SRCResume', 'SPEI_TTS_PRIVATE', 'SPVISEMES',
    'SGRSTTDictation', 'SPEI_RECO_OTHER_CONTEXT', 'SECLowConfidence',
    'SpeechGrammarTagUnlimitedDictation', 'SPGRAMMARSTATE',
    'DISPID_SVVoice', 'DISPID_SPEsItem', 'DISPID_SPCLangId',
    'DISPID_SVPause', 'SpeechStreamSeekPositionType', 'SPXRO_SML',
    'SpInprocRecognizer', 'SpeechRuleState', 'SRSActiveAlways',
    'SPLO_STATIC', 'ISpeechPhraseInfo', 'SVP_16',
    'SpSharedRecoContext', 'DISPID_SRCCmdMaxAlternates',
    'SpeechCategoryAudioIn', 'DISPID_SDKSetStringValue',
    'DISPID_SDKDeleteKey', 'SPVPRI_ALERT', 'DISPID_SGRSTransitions',
    'DISPID_SpeechRecoContextEvents', 'SPRST_INACTIVE',
    'SAFT22kHz16BitStereo', 'ISpeechRecoResult', 'SGRSTTEpsilon',
    'DISPID_SWFEFormatTag', 'DISPID_SRCERecognition',
    'DISPID_SPIElements', 'SpeechVoiceSpeakFlags',
    'SWPKnownWordPronounceable', 'DISPID_SPARecoResult',
    'DISPID_SPAs_NewEnum', 'tagSPTEXTSELECTIONINFO', 'SPINTERFERENCE',
    'DISPID_SVSRunningState', 'DISPID_SPPId',
    'DISPID_SLGetGenerationChange', 'DISPID_SOTs_NewEnum',
    'eLEXTYPE_RESERVED9', 'SpeechRegistryUserRoot',
    'DISPID_SVEAudioLevel', 'ISpGrammarBuilder', 'SpeechRecoEvents',
    'SECFEmulateResult', 'ISpeechCustomStream', 'SP_VISEME_3',
    'DISPID_SVStatus', 'SPFM_CREATE_ALWAYS',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SpeechPhraseRule',
    'SVP_10', 'SpeechMicTraining', 'SPBO_PAUSE',
    'DISPID_SVGetProfiles', 'SAFT11kHz16BitStereo', 'SPAO_NONE',
    'SITooFast', 'DISPID_SLPSymbolic', 'DISPID_SPILanguageId',
    'DISPID_SPELexicalForm', 'DISPID_SOTCSetId', 'SRARoot',
    'DISPID_SPRuleConfidence', 'DISPID_SVGetVoices',
    'SPEVENTSOURCEINFO', 'SP_VISEME_7',
    'ISpPhoneticAlphabetSelection', 'DISPID_SPPNumberOfElements',
    'DISPID_SGRName', 'SREAdaptation', 'DISPID_SRSetPropertyNumber',
    'SpObjectToken', 'SAFTGSM610_22kHzMono', 'SGRSTTWord',
    'DISPID_SPEPronunciation', 'SVSFNLPMask', 'SRSInactive',
    'DISPID_SRIsShared', 'DISPID_SBSSeek', 'ISpeechAudio',
    'DISPID_SGRSTType', 'SPEI_MAX_SR', 'ISpPhraseAlt',
    'DISPID_SVVolume', 'SPAS_RUN', 'SRATopLevel',
    'DISPID_SRGetPropertyString', 'DISPID_SPEActualConfidence',
    'DISPID_SLPsItem', 'SPSMF_SRGS_SAPIPROPERTIES', 'SRESoundEnd',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SLRemovePronunciation', 'SSTTTextBuffer',
    'DISPID_SGRSTText', 'DISPID_SpeechRecognizer',
    'ISpeechPhoneConverter', 'ISpResourceManager',
    'ISpeechMemoryStream', 'DISPID_SpeechPhraseElement',
    'SPEI_TTS_BOOKMARK', 'DISPID_SGRSTsCount',
    'SpObjectTokenCategory', 'DISPID_SVSLastResult',
    'DISPID_SGRs_NewEnum', 'DISPID_SGRsDynamic', 'SECFNoSpecialChars',
    'ISpeechGrammarRuleStateTransition',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPRULE',
    'SAFTCCITT_ALaw_44kHzStereo', 'SP_VISEME_1',
    'SAFT32kHz8BitStereo', 'SPSHT_Unknown', 'SPPS_Interjection',
    'SpeechTokenIdUserLexicon', 'DISPID_SVSLastBookmarkId',
    'ISpeechDataKey', 'SAFTExtendedAudioFormat',
    'DISPID_SpeechBaseStream', 'DISPID_SGRId',
    'SPINTERFERENCE_NOSIGNAL', 'SPRST_ACTIVE_ALWAYS',
    'SSSPTRelativeToStart', 'SGLexical', 'DISPID_SRRPhraseInfo',
    'STSF_AppData', 'DISPID_SWFEChannels', 'DISPID_SPEDisplayText',
    'SAFT11kHz8BitMono', 'SpeechTokenValueCLSID',
    'SAFT24kHz8BitStereo', 'ISpeechBaseStream', 'SPSHORTCUTTYPE',
    'SPSHORTCUTPAIR', 'SGSEnabled', 'DISPID_SVEEnginePrivate',
    'SPEI_RESERVED6', 'SPEI_SR_BOOKMARK', 'SP_VISEME_15',
    'SPEVENTENUM', 'DISPID_SpeechLexiconPronunciation',
    'ISpeechPhraseAlternates', 'DISPID_SRRAudioFormat',
    ...
    'DISPID_SPEAudioSizeTime', 'ISpProperties', 'SECHighConfidence',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SWFEBitsPerSample', 'SPVPRI_NORMAL',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SAFSetWaveFormatEx',
    'DISPIDSPRG', 'SPFM_OPEN_READWRITE',
    ...
    'SPSModifier', 'DISPID_SAFGetWaveFormatEx',
    'SpeechRecognizerState', 'ISpeechPhraseElement',
    'SVEStartInputStream', 'eLEXTYPE_PRIVATE17',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SABIEventBias',
    'DISPID_SRCEPropertyStringChange', '_SPAUDIOSTATE',
    'eLEXTYPE_PRIVATE13', 'SDA_One_Trailing_Space',
    'DISPID_SLWsCount', 'DISPID_SpeechPhoneConverter',
    'SVSFUnusedFlags', 'DISPID_SpeechGrammarRuleStateTransitions',
    'eLEXTYPE_PRIVATE10', 'ISpStreamFormat', 'SVEVoiceChange',
    'SP_VISEME_13', 'DISPID_SPEsCount', 'SPVPRIORITY',
    'DISPID_SPCPhoneToId', 'SPBO_AHEAD', 'SPCT_COMMAND',
    'DISPID_SOTsItem', 'SRAORetainAudio', 'SpWaveFormatEx',
    'DISPID_SRCESoundEnd', 'DISPID_SPAsCount',
    ...
    'SVP_14', 'DISPID_SOTGetStorageFileName', '__MIDL_IWinTypes_0009',
    'SPWT_DISPLAY', 'SPWT_LEXICAL', 'eLEXTYPE_PRIVATE16',
    'DISPID_SPRuleParent', 'SREInterference', 'SRCS_Disabled',
    'SPRECOGNIZERSTATUS', 'SpeechRecoProfileProperties',
    'SPAS_CLOSED', 'SAFT16kHz8BitStereo', 'SAFT22kHz8BitStereo',
    'DISPID_SpeechCustomStream', 'SGSDisabled', 'STSF_FlagCreate',
    'SPSSuppressWord', 'DISPID_SWFEAvgBytesPerSec',
    'SpeechAudioState', 'DISPID_SGRSTNextState',
    'SpeechRetainedAudioOptions', 'SRERequestUI', 'SGRSTTTextBuffer',
    'STCRemoteServer', 'SAFTNoAssignedFormat', 'SSTTDictation',
    'DISPID_SLPsCount', 'ISpObjectTokenCategory', 'SVPOver',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'IInternetSecurityMgrSite', 'SAFTCCITT_uLaw_44kHzStereo',
    'SPEI_UNDEFINED', 'DISPID_SRCEHypothesis', 'SPWF_INPUT',
    'SRESoundStart', 'ISpeechLexiconWord', 'SRADefaultToActive',
    'DISPID_SRCEEnginePrivate', 'SBONone',
    ...
    'SpeechGrammarTagDictation', 'SpeechPropertyResponseSpeed',
    'SpSharedRecognizer', 'SPEI_TTS_AUDIO_LEVEL',
    'SAFTCCITT_uLaw_22kHzStereo', 'SECFIgnoreCase',
    'DISPID_SRSSupportedLanguages', 'SpCompressedLexicon',
    'ISpRecognizer2', 'ISpMMSysAudio', 'DISPID_SLWLangId',
    'DISPID_SGRsCommitAndSave', 'SpPhoneConverter',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SAFTCCITT_uLaw_44kHzMono',
    'SPCT_DICTATION', 'SPSHORTCUTPAIRLIST',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SRGState',
    'DISPID_SGRInitialState', 'DISPID_SVGetAudioOutputs',
    'DISPIDSPTSI_ActiveLength', 'SpFileStream', 'SVEPrivate',
    'DISPID_SREmulateRecognition', 'DISPID_SRRSaveToMemory',
    'ISpeechRecognizer', 'DISPID_SVSInputSentenceLength',
    'SAFTDefault', 'SPAUDIOSTATUS', 'SVP_21', 'ISpeechResourceLoader',
    'DISPID_SLGetWords', 'DISPID_SRCEPropertyNumberChange',
    'SAFT48kHz8BitStereo', 'DISPID_SABIMinNotification',
    'SVSFVoiceMask', 'ISpeechRecoGrammar', 'SPWT_PRONUNCIATION',
    'SDA_Consume_Leading_Spaces', 'SpMemoryStream', 'DISPID_SLWsItem',
    'ISpShortcut', 'ISpeechRecoResultTimes',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SRGDictationSetState',
    'SECFIgnoreWidth', 'SpeechWordType', 'DISPID_SMSADeviceId',
    'DISPID_SASState', 'SREAllEvents', 'SAFTGSM610_8kHzMono',
    'SPSMF_UPS', 'DISPID_SpeechVoiceStatus',
    'DISPID_SpeechObjectTokens', 'ISpeechPhraseProperty',
    'SPWORDLIST', 'SAFT44kHz16BitMono', 'DISPID_SGRSTs_NewEnum',
    'SPEVENT', 'SPEI_VISEME', 'SPVPRI_OVER', 'DISPID_SOTRemove',
    'SP_VISEME_18', 'DISPID_SVDisplayUI', 'DISPID_SRCPause',
    'SAFT32kHz16BitMono', 'ISpRecoContext', 'DISPID_SPACommit',
    'SLTApp', 'SREStreamEnd', 'DISPID_SRGCmdLoadFromMemory', 'SPWORD',
    'ISpeechAudioFormat', 'SVP_8', 'ISpeechRecoResult2',
    'ISpeechRecoResultDispatch', 'ISpSerializeState',
    'DISPID_SRCRequestedUIType', 'SITooLoud', 'DISPID_SLPs_NewEnum',
    'SITooQuiet', 'SPCS_ENABLED', 'SVP_3', 'STCLocalServer',
    'DISPID_SPAsItem', 'SpeechRunState', 'DISPID_SPIGetText',
    'SGPronounciation', 'DISPID_SASNonBlockingIO',
    'DISPID_SPRules_NewEnum', 'ISpNotifyTranslator',
    'DISPID_SVSInputWordPosition', 'eLEXTYPE_PRIVATE5',
    'DISPID_SPRsCount', 'SREHypothesis', 'SPEI_WORD_BOUNDARY',
    'SpeechEngineConfidence', 'DISPID_SRSetPropertyString',
    'SREStreamStart', 'DISPID_SWFESamplesPerSec', 'SRCS_Enabled',
    'DISPID_SCSBaseStream', 'eLEXTYPE_PRIVATE3',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPEI_SR_PRIVATE',
    'SPRS_ACTIVE', 'IInternetSecurityManager', 'SP_VISEME_4',
    'SpeechSpecialTransitionType', 'SAFT44kHz8BitStereo',
    'ISpDataKey', 'DISPID_SRCRetainedAudioFormat',
    'SSFMCreateForWrite', 'DISPID_SPIGetDisplayAttributes',
    'ISpNotifySink', 'DISPID_SRGDictationUnload',
    'DISPID_SPERequiredConfidence', 'SPEI_VOICE_CHANGE',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SPIReplacements',
    'SVPAlert', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SVSCurrentStreamNumber', 'SDTRule', 'DISPID_SVRate',
    ...
    'SDKLCurrentConfig', 'SDA_Two_Trailing_Spaces',
    'SpeechEngineProperties', 'ISequentialStream', 'SVP_0',
    'DISPID_SOTSetId', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SASetState', 'SREFalseRecognition',
    'DISPID_SpeechDataKey', 'SPSUnknown', 'DISPID_SPPName',
    'DISPID_SRCState', 'SpeechCategoryRecognizers', 'SPPS_Noncontent',
    'ISpeechFileStream', 'ISpeechWaveFormatEx', 'SPAR_Unknown',
    'SAFTADPCM_22kHzMono', '_RemotableHandle', 'SVSFIsFilename',
    'SPSTREAMFORMATTYPE', 'SpMMAudioOut', 'DISPID_SDKGetBinaryValue',
    'SpeechDataKeyLocation', 'DISPID_SMSAMMHandle',
    'DISPID_SVSpeakStream', 'SPEI_RESERVED3', 'DISPID_SGRsCommit',
    'DISPID_SRGCommit', 'DISPID_SPIRetainedSizeBytes',
    'SpeechCategoryAudioOut', 'DISPID_SGRsCount',
    'DISPID_SGRsFindRule', 'SPEI_END_SR_STREAM',
    'ISpeechGrammarRules', 'DISPID_SRRTimes', 'SAFTADPCM_44kHzStereo',
    'DISPID_SPPs_NewEnum', 'DISPID_SAFGuid', 'DISPID_SRAudioInput',
    'SPEI_MIN_SR', 'SRTExtendableParse',
    'DISPID_SPERetainedStreamOffset', 'IEnumString',
    'SPAUDIOBUFFERINFO', 'SPPHRASEELEMENT', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SBSFormat', 'SRTReSent', 'DISPID_SpeechObjectToken',
    'SDTAlternates', 'SAFT24kHz8BitMono', 'ISpeechPhraseReplacements',
    'DISPID_SGRSTPropertyName', 'SVF_Emphasis', 'SINoSignal',
    'SPPS_NotOverriden', 'SVEViseme', 'SAFT16kHz16BitStereo',
    'DISPID_SRCERequestUI', 'SpeechWordPronounceable',
    'DISPID_SGRSTWeight', 'SpeechEmulationCompareFlags',
    'SPAUDIOOPTIONS', 'eWORDTYPE_DELETED',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SGRSTRule',
    'SDA_No_Trailing_Space', 'SVP_4', 'SAFTGSM610_11kHzMono',
    'DISPID_SPIGrammarId', 'SPCT_SUB_DICTATION',
    'DISPID_SpeechPhraseInfo', 'DISPID_SVIsUISupported',
    'SpeechAddRemoveWord', 'DISPID_SPPEngineConfidence',
    'eLEXTYPE_PRIVATE19', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SMSGetData', 'DISPID_SVSkip', 'SRADynamic',
    'DISPID_SRRAlternates', 'DISPIDSPTSI_SelectionOffset',
    'tagSPPROPERTYINFO', 'SDKLLocalMachine', 'DISPID_SOTId',
    'SAFTADPCM_11kHzStereo', 'SPSHT_NotOverriden',
    'DISPID_SRIsUISupported', 'SAFT48kHz16BitMono',
    'SpTextSelectionInformation', 'DISPID_SpeechPhraseAlternate',
    'eLEXTYPE_PRIVATE14', 'DISPID_SpeechLexiconWords', 'SP_VISEME_9',
    'ISpeechAudioBufferInfo', 'SpStream', 'SAFT44kHz8BitMono',
    'WAVEFORMATEX', 'SVEAudioLevel', 'SVSFParseSapi', 'SDTAudio',
    'SREPhraseStart', 'SASStop', 'SpeechFormatType',
    'DISPID_SRCreateRecoContext', 'SAFT48kHz8BitMono',
    'SpeechCategoryAppLexicons', 'DISPID_SRCRecognizer',
    'DISPID_SpeechGrammarRuleState', 'ISpEventSource',
    'DISPID_SASFreeBufferSpace', 'DISPID_SVEPhoneme',
    'DISPID_SOTCEnumerateTokens', 'SLODynamic', 'SP_VISEME_11',
    'SPGS_ENABLED', 'SPPS_Verb', 'SPWORDTYPE', 'eLEXTYPE_PRIVATE2',
    'DISPID_SDKSetLongValue', 'SP_VISEME_5',
    'SpeechGrammarTagWildcard', 'DISPID_SRRAudio',
    'IEnumSpObjectTokens', 'SPBOOKMARKOPTIONS',
    'DISPID_SOTGetDescription', 'DISPID_SPPParent', 'SPEI_MIN_TTS',
    'ISpeechPhraseRule', 'DISPID_SOTGetAttribute', 'SLOStatic',
    'DISPID_SRStatus', 'DISPID_SPAStartElementInResult',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SVP_5', 'SDKLCurrentUser',
    'SVEPhoneme', 'DISPID_SRCSetAdaptationData', 'SAFT16kHz16BitMono',
    'SpeechGrammarRuleStateTransitionType', 'SBOPause',
    'SAFTNonStandardFormat', 'SPSNoun', 'DISPID_SWFEBlockAlign',
    'eLEXTYPE_PRIVATE7', 'DISPID_SOTDisplayUI',
    'DISPID_SRGetRecognizers', 'DISPID_SpeechLexiconWord',
    'SPRULESTATE', 'DISPID_SASCurrentSeekPosition',
    'SVSFNLPSpeakPunc', 'DISPID_SVEStreamStart', 'SREBookmark',
    'DISPID_SpeechGrammarRuleStateTransition', 'SVSFParseSsml',
    'SSSPTRelativeToEnd', 'ISpeechVoice', 'SAFT8kHz16BitStereo',
    '_ISpeechVoiceEvents', 'SPFM_OPEN_READONLY', 'SWTDeleted',
    'SPPARTOFSPEECH', 'DISPID_SRGCmdLoadFromObject',
    'SPEI_HYPOTHESIS', 'SPXRO_Alternates_SML', 'SpeechVisemeFeature',
    'DISPID_SGRsAdd', 'DISPID_SOTRemoveStorageFileName', 'SPSVerb',
    'SpeechTokenKeyFiles', 'DISPID_SpeechPhraseReplacements', 'SVP_7',
    'ISpeechGrammarRule', 'SpVoice', 'ISpeechPhraseInfoBuilder',
    'SLTUser', 'SPPS_Noun', 'SpCustomStream', 'SRSActive', 'LONG_PTR',
    'DISPID_SVEStreamEnd', 'DISPID_SRSAudioStatus',
    'DISPID_SpeechLexiconProns', 'SpeechBookmarkOptions',
    'SpeechDiscardType', 'DISPID_SGRSAddWordTransition',
    'DISPID_SRCEventInterests', 'SAFT32kHz16BitStereo',
    'SVESentenceBoundary', 'DISPID_SRRSetTextFeedback',
    'Speech_Default_Weight', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SADefaultFormat', 'SPPS_LMA',
    'DISPID_SPEDisplayAttributes', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SDKCreateKey', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SpeechAudioFormat', 'DISPID_SGRAddState',
    'DISPID_SGRSRule', 'SPPS_Modifier', 'SpResourceManager',
    'SDTProperty', 'SPLEXICONTYPE', 'SSTTWildcard',
    'DISPID_SLPPartOfSpeech', 'SpeechCategoryPhoneConverters',
    'DISPIDSPTSI', 'DISPID_SRGDictationLoad',
    'eLEXTYPE_VENDORLEXICON', 'SVEEndInputStream',
    'DISPID_SRCESoundStart', 'SPAUDIOSTATE', 'SpMMAudioEnum',
    'SpeechTokenKeyUI', 'DISPID_SDKDeleteValue', 'SPGS_EXCLUSIVE',
    'STCInprocServer', 'eLEXTYPE_PRIVATE9', 'DISPID_SPPChildren',
    'SPSERIALIZEDPHRASE', 'SpeechTokenContext',
    'SRSInactiveWithPurge', 'eLEXTYPE_PRIVATE12', 'SRTSMLTimeout',
    'SAFTCCITT_ALaw_22kHzStereo', 'SPDKL_CurrentUser',
    'DISPID_SLGenerationId', 'SVP_12', 'SPINTERFERENCE_NOISE',
    'DISPID_SLPPhoneIds', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SPSEMANTICFORMAT',
    'SPEI_RESERVED2', 'DISPID_SGRSTsItem', 'SGDisplay',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SRSNumberOfActiveRules',
    'SAFTADPCM_11kHzMono', 'DISPID_SpeechPhraseRules', 'SPRST_ACTIVE',
    'SVP_6', 'ISpRecognizer', 'DISPID_SDKOpenKey',
    'DISPID_SRCEInterference', 'SPEI_SOUND_END', 'SPCS_DISABLED',
    'SPSInterjection', 'SAFT22kHz8BitMono', 'SpeechAudioProperties',
    'DISPID_SLAddPronunciation', 'DISPID_SVEVoiceChange', 'IStream',
    'DISPID_SpeechVoice', 'SREAudioLevel', 'SGDSActive',
    'SAFTCCITT_ALaw_11kHzMono', 'Speech_StreamPos_Asap',
    'DISPID_SABIBufferSize', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SVEBookmark', 'SVP_2', 'DISPID_SRCEPhraseStart',
    'SRAInterpreter', 'SITooSlow', 'eLEXTYPE_MORPHOLOGY', 'SVP_19',
    'SAFT22kHz16BitMono', 'ISpeechLexicon', 'eLEXTYPE_PRIVATE6',
    'DISPID_SpeechLexicon', 'SPSHT_OTHER', 'SPPHRASERULE',
    'SAFT32kHz8BitMono', 'SPGRAMMARWORDTYPE', 'ISpeechPhraseElements',
    'SpeechAllElements', 'SpUnCompressedLexicon', 'SFTSREngine',
    'SPDKL_CurrentConfig', 'SpeechTokenKeyAttributes',
    'DISPID_SVEWord', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SDKSetBinaryValue', 'DISPID_SRCEFalseRecognition',
    'SAFT12kHz16BitStereo', 'SAFTADPCM_22kHzStereo', 'SP_VISEME_12',
    'SVP_11', 'SRAONone', 'SPAO_RETAIN_AUDIO',
    ...
    'STCAll', 'SpeechLoadOption', 'SP_VISEME_10',
    'ISpeechLexiconPronunciations', 'ISpRecoResult',
    'SPEI_REQUEST_UI', 'SVSFParseMask', 'ISpeechXMLRecoResult',
    'Speech_StreamPos_RealTime', 'DISPID_SVGetAudioInputs',
    'SREPropertyStringChange', 'SPEI_RECOGNITION', 'DISPID_SPRsItem',
    'SVP_13', 'DISPID_SFSOpen', 'ISpeechObjectToken',
    'DISPID_SpeechGrammarRules', 'ISpStream', 'SASClosed',
    'SVPNormal', 'SPWORDPRONOUNCEABLE', 'DISPID_SMSALineId',
    'SVF_None', 'SPRST_NUM_STATES', 'ISpRecoCategory',
    'DISPID_SDKGetStringValue', 'DISPID_SPIProperties',
    'SAFTCCITT_uLaw_8kHzStereo', 'ISpeechLexiconWords',
    'SPEI_PHRASE_START', 'ISpeechObjectTokens',
    'SGLexicalNoSpecialChars', 'DISPID_SLWs_NewEnum',
    'DISPID_SVResume', 'STSF_LocalAppData', 'tagSTATSTG',
    'DISPID_SRSCurrentStreamNumber', 'SPAS_PAUSE',
    'DISPID_SRGSetTextSelection', 'SGRSTTRule', 'SRAExport',
    'SPEI_RESERVED1', 'SVF_Stressed', 'DISPID_SRCVoice',
    'DISPID_SpeechPhraseProperty', 'SpeechAudioFormatGUIDWave',
    'DISPID_SRGIsPronounceable', 'DISPID_SpeechVoiceEvent',
    'eLEXTYPE_PRIVATE18', 'SPSERIALIZEDRESULT', 'SpInProcRecoContext',
    'SGDSActiveUserDelimited', 'DISPID_SVAudioOutput', 'ISpPhrase',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SpeechRecoResult',
    'SP_VISEME_20', 'eLEXTYPE_PRIVATE4', 'DISPID_SRRTStreamTime',
    'SPFM_NUM_MODES', 'DISPID_SRDisplayUI', 'SPRS_INACTIVE',
    'DISPID_SPRulesItem', 'eLEXTYPE_PRIVATE11', 'SPPHRASEREPLACEMENT',
    'SpShortcut', 'SPEI_RESERVED5', 'DISPID_SMSSetData', 'ISpLexicon',
    'DISPID_SRGCmdSetRuleState', 'SPEI_START_INPUT_STREAM',
    'SP_VISEME_6', 'ISpeechPhraseRules', 'DISPID_SLPLangId',
    'DISPID_SRCERecognizerStateChange', 'SpeechVisemeType',
    'SPRS_ACTIVE_USER_DELIMITED', 'SpeechRuleAttributes', 'SPBO_NONE',
    'SWPUnknownWordPronounceable', 'SPEI_SOUND_START',
    'DISPID_SRCBookmark', 'SPRST_INACTIVE_WITH_PURGE', 'SPAR_Low',
    'SpeechPropertyResourceUsage', 'SpeechCategoryVoices',
    'SAFT44kHz16BitStereo', 'SRERecoOtherContext',
    ...
    'SRSEDone', 'DISPID_SGRAttributes', 'SVSFIsNotXML', 'SASPause',
    'eLEXTYPE_PRIVATE15', 'DISPID_SVSInputSentencePosition',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SOTCDefault',
    'DISPID_SPRulesCount', 'SPPHRASEPROPERTY',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'ISpNotifySource', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SVWaitUntilDone', 'SPEI_END_INPUT_STREAM',
    'ISpeechTextSelectionInformation',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPDATAKEYLOCATION',
    'DISPID_SPRDisplayAttributes', 'SPSFunction',
    'SpeechPropertyComplexResponseSpeed', 'SGDSInactive',
    'DISPID_SRRTTickCount', 'DISPID_SVPriority'
]

_check_version('1.1.14', 1652500363.435019)
